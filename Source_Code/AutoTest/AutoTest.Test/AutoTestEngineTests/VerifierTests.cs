...
namespace AutoTest.Test.AutoTestEngineTests
{
    ...
    public class VerifierTests
    {
        ...
        [TestMethod]
        public void Return_Val_Verifier_Test_Ent_Data_Serialization_Errors()
        {
            var SUT = new ReturnValVerifier(_successSerHelper.Object, _failUnserializableTypehelper.Object);
            var data = new InterceptionProcessingData(DataHelper.DateTimeAddDaysData.Entry, _config);
            var res = SUT.Verify(data);
        ...
        [TestMethod]
        public void Return_Val_Verifier_Test_Exc_Data_No_Serialization_Errors()
        {
            var SUT = new ReturnValVerifier(_successSerHelper.Object, _successUnserializableTypehelper.Object);
            var data = new InterceptionProcessingData(DataHelper.DateTimeAddDaysData.Exception, _config);
            var res = SUT.Verify(data);
        ...
        [TestMethod]
        public void Return_Val_Verifier_Test_Exc_Data_Serialization_Errors()
        {
            var SUT = new ReturnValVerifier(_successSerHelper.Object, _failUnserializableTypehelper.Object);
            var data = new InterceptionProcessingData(DataHelper.DateTimeAddDaysData.Exception, _config);
            var res = SUT.Verify(data);
        ...
        [TestMethod]
        public void Return_Val_Verifier_Test_Exit_Data_No_Serialization_Errors()
        {
            var SUT = new ReturnValVerifier(_successSerHelper.Object, _successUnserializableTypehelper.Object);
            var data = new InterceptionProcessingData(DataHelper.DateTimeAddDaysData.Exit, _config);
            var res = SUT.Verify(data);
        ...
        [TestMethod]
        public void Return_Val_Verifier_Test_Exit_Data_Serialization_Errors()
        {
            var SUT = new ReturnValVerifier(_successSerHelper.Object, _failUnserializableTypehelper.Object);
            var data = new InterceptionProcessingData(DataHelper.DateTimeAddDaysData.Exit, _config);
            var res = SUT.Verify(data);
