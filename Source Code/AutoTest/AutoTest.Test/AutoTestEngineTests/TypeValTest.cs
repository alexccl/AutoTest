...
namespace AutoTest.Test.AutoTestEngineTests
{
    ...
    public class TypeValTest
    {
        ...
        [TestMethod]
        public void Type_Val_Test_Assign_Val_Of_Dif_Type_Throws_Exception()
        {
            ...
            try
            {
                typeVal = new TypeValModel(typeof(string), 1);
            }
            catch (AutoTestEngineException ex)
            {
                exceptionThrown = true;
