 ...
 foreach(var test in data.Tests) 
{
		...
		else
		{
            ...
            this.Write("\t\r\n\t\tprivate ComparisonResult Compare(object obj1, object obj2)\r\n\t\t{\r\n\t\t\tCompareL" +
                    ...
                    "j1, obj2);\r\n\t\t}\r\n\t\r\n\t\tprivate object SetPropertyOnType(Type classType, object cl" +
                    "assInstance, Type propertyType, object propertyInstance)\r\n\t\t{\r\n\t\t\tvar props = cl" +
                    "assType.GetProperties();\r\n\t\t\tforeach(var prop in props)\r\n\t\t\t{\r\n\t\t\t\tif(prop.Prope" +
                    "rtyType != propertyType) continue;\r\n\t\r\n\t\t\t\tprop.SetValue(classInstance, property" +
